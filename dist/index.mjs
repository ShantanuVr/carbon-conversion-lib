...
export { GWhToKWh, InvalidFactorError, InvalidUnitError, MWhToKWh, NoFactorForDateError, UnknownRegionError, approximatelyEqual, avoidedEmissions, avoidedEmissionsWithMethodology, avoidedEmissionsWithUncertainty, batchAvoidedEmissions, batchToCO2eTonnes, calculatePercentage, calculateUncertaintyBounds, clamp, createDigest, formatFixed, getAvailableRegions, getAvailableScopes, getEnergyConversionFactor, getFactorById, getFactorsByRegionAndScope, getLatestFactor, getMassConversionFactor, getRegionInfo, loadFactorPack as initializeDefaultFactors, initializeFactorRegistry, isRegionSupported, kWhToGWh, kWhToMWh, kgToTonnes, listFactors, loadFactorPack, normalizeToKWh, normalizeToKgCO2e, normalizeToTonnesCO2e, parseFixed, resolveFactor, roundStable, safeAdd, safeMultiply, safeProduct, safeSum, stableEqual, stableStringify, toCO2eKg, toCO2eKgRounded, toCO2eTonnes, toCO2eTonnesRounded, toCO2eWithUncertainty, toHashString, tonnesToKg, totalAvoidedEmissions, totalCO2eTonnes, validateAvoidedInput, validateFactor, validateFactorPack, validateRegionPack };
